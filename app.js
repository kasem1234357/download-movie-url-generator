...
const generateTv = async(browser,page,title,epsoide,season)=>{
	await page.goto(`https://xn------nzebcaa6hd5qde3bjgmh.myciima-weciima.shop/watch/%d9%85%d8%b4%d8%a7%d9%87%d8%af%d8%a9-%d9%85%d8%b3%d9%84%d8%b3%d9%84-${title}-%d9%85%d9%88%d8%b3%d9%85-${season}-%d8%ad%d9%84%d9%82%d8%a9-${epsoide}/`);
	const searchResultSelector = '.List--Download--Wecima--Single a';
